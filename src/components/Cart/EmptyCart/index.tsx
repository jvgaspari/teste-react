...
const EmptyCart: React.FC = () => {
  ...
  return (
    <Box flex={1} pb={'169px'}>
      <Box flex={1} bgcolor='#FFFFFF' justifyContent={'center'} alignItems='center' p={'16px'}>
          ...
          <Box display={'flex'} justifyContent='center' alignItems={'center'} mb='32px'>
            <Image width={447} height={265.8} src={emptyCartImage} alt={''}></Image>
          </Box>
          <Box display={'flex'} justifyContent='center' alignItems={'center'}>
              <Button 
                onClick={goBack}
                sx={{width: '180px', height: '40px', bgcolor: '#009EDD', mb: '64px', ':hover': { opacity: 0.7, bgcolor: '#009EDD' }}}
              >
                <Typography
                color={'#FFFFFF'} fontWeight={700} fontSize={14} lineHeight={'19px'}
                >
                  VOLTAR
              </Typography>
              </Button>
